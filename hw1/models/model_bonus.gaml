...
species people skills: [moving] {
	...
	reflex every_tick when: target_dest = nil {
		...
		if type = "Visitor" { // evil/security ppl don't get hungry
		...
		// refresh color
		if target_dest = nil and type != "Security" {
			color <- type = "Evil" ? #red : #yellow;
		}
		
		// TODO: encounter disturbance   ---  should this overwrite hunger/thirst? (they'll resume after reaching info center)
		//if (neighbour within distance)
...
experiment festival_traffic type: gui {
	parameter "Number of agents" var: num_people category: "People" min: 10 max: 100;
	parameter "minimal speed" var: min_speed category: "People" min: 0.1 #km/#h ;
	parameter "maximal speed" var: max_speed category: "People" max: 10 #km/#h;
	parameter "Evil probability (%)" var: evil_prob category: "People" min: 1 max: 100;
	parameter "Number of security" var: num_security category: "People" min: 1;
